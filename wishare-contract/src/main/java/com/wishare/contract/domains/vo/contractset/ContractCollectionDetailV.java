...
@ApiModel(value = "contract_collection_detail请求对象", description = "合同收款明细表")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ContractCollectionDetailV {
