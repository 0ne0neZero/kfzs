...
public class ContractIncomeConcludeDetailV {
    ...
    private List<ContractIncomeFundV> contractIncomeFundVList;
    ...
    @ApiModelProperty("市拓投模测算URL")
    private String tmCalculationUrl;
