...
@TableName("contract_pay_conclude")
public class ContractPayConcludeE {
    ...
    //是否审批通过（0.否；1.是）
    private Integer isSptg = 0;
    //BPM状态（0.未发起；1.已发起;2.已通过;3.已驳回）
    ...
    public static final String NK_STATUS = "nkStatus";
