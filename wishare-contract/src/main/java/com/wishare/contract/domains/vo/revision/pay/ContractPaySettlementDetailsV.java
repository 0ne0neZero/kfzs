...
import com.wishare.contract.domains.vo.revision.pay.settlement.ContractPaySettlementContractInfoV;
...
public class ContractPaySettlementDetailsV {
    ...
    @ApiModelProperty("V2.13-结算单-成本计划信息")
    private List<PayCostPlanV> payCostPlanVList;
}
