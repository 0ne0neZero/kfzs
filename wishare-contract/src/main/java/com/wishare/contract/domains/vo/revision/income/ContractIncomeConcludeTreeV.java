...
@ApiModel(value = "收入合同订立信息表视图对象", description = "收入合同订立信息表视图对象")
public class ContractIncomeConcludeTreeV extends Tree<ContractIncomeConcludeTreeV,String> {
