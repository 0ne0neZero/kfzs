...
/**
* <p>
* ContractBondCarryoverDetail 表字段常量 <br>
*
...
* @since 2022-11-21
*/
public interface ContractBondCarryoverDetailFieldConst {
     ...
     * 关联投标保证金账单编号
     */
    String BID_BOND_BILL_NO = "bidBondBillNo";
     ...
     * 申请结转时间
     */
    String CARRYOVER_TIME = "carryoverTime";
