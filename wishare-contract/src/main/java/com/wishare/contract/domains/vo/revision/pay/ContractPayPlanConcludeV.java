...
public class ContractPayPlanConcludeV extends Tree<ContractPayPlanConcludeV,String> {
    ...
    @ApiModelProperty("合同应结算金额总额")
    private BigDecimal contractTotalSettledAmount;
