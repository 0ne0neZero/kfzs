...
/**
* <p>
* 收入合同-团队表 原生请求参数，该类会在每次重新自动生成时，重新生成！！！
* </p>
*
* @author chenglong
* @since 2023-06-28
...
@ApiModel(value = "收入合同-团队表原始请求参数", description = "收入合同-团队表原始请求参数，会跟着表重新生成")
public class ContractIncomeTeamRawF {
    ...
    */
    ...
    @ApiModelProperty("需要查询返回的字段，不传时返回以下全部，可选字段列表如下"
        + "[\"id\",\"contractId\",\"name\",\"orgId\",\"departId\",\"departName\",\"orgName\",\"role\",\"endDate\",\"tenantId\",\"creator\",\"creatorName\",\"gmtCreate\",\"operator\",\"operatorName\",\"gmtModify\",\"deleted\"]"
        + "id 主键ID"
        + "contractId 关联合同ID"
        + "name 姓名"
        + "orgId 所属公司ID"
