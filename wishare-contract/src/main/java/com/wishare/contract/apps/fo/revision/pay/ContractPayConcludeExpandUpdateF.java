...
/**
* <p>
* 支出合同订立信息拓展表 更新请求参数 不会跟着表结构更新而更新
* </p>
*
* @author chenglong
* @since 2023-09-22
...
@ApiModel(value = "支出合同订立信息拓展表更新请求参数", description = "支出合同订立信息拓展表")
public class ContractPayConcludeExpandUpdateF {

    /**
    * id 不可为空
    */
    @ApiModelProperty(value = "支出合同订立信息拓展表id",required = true)
    @NotNull(message = "主键支出合同订立信息拓展表id不可为空")
    private Long id;
    /**
    * contractId
    */
