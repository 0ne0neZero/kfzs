 ...
 * @Description：
 * @Author： chentian
 * @since： 2023/7/4  17:17
 */
@Data
@ApiModel(value = "客户基础信息返回数据")
public class CustomerRv {
     ...
     * 营业期限开始-结束日期数组
     */
    @ApiModelProperty("营业期限开始-结束日期数组")
    private List<String> busStartEndList;
    /**
     * 行业分类编码
     */
     ...
     * 是否成交:0未成交，1已成交
     */
    @ApiModelProperty("是否成交:0未成交，1已成交")
