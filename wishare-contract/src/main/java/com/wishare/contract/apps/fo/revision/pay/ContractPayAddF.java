...
@ApiModel(value = "支出合同订立信息表新增参数AddF", description = "支出合同订立信息表新增参数AddF")
public class ContractPayAddF {
    ...
    private String incomeexpendtype = "02";
    /**
     * conperformcountry
     */
    ...
    @ApiModelProperty("清单")
    private List<ContractPayFundUpdateF> contractPayFundVList;
