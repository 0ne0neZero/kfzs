...
import com.wishare.contract.apps.fo.revision.income.ContractIncomeConcludeExpandAllF;
...
@ApiModel(value = "支出合同订立信息表新增请求参数", description = "支出合同订立信息表新增请求参数")
public class ContractPayConcludeSaveF {
