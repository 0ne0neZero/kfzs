...
@ApiModel(value = "收入合同订立信息拓展表分页请求参数", description = "收入合同订立信息拓展表")
public class ContractIncomeConcludeExpandPageF {
    ...
    */
    ...
    @ApiModelProperty("需要查询返回的字段，不传时返回全部，可选字段列表如下"
        + "[\"id\",\"contractId\",\"conlanguage\",\"conname\",\"issupplycontract\",\"oppositeconmaincode\",\"incomeexpendtype\",\"conperformcountry\",\"conperformprovinces\",\"conperformcity\",\"conperformxian\",\"disputesolutionway\",\"conmodelusecondition\",\"conundertakerid\",\"conundertaker\",\"conundertakercontact\",\"taxrate\",\"taxamt\",\"hsbgamt\",\"tzxx\",\"fkdwxx\",\"skdwxx\",\"bzjxx\",\"spxx\",\"fjxx\",\"creator\",\"creatorName\",\"gmtCreate\",\"operator\",\"operatorName\",\"gmtModify\",\"deleted\"]"
        + "id 收入合同订立信息拓展表id"
        + "contractId 合同id"
        + "conlanguage 合同语言"
        + "conname 合同名称"
