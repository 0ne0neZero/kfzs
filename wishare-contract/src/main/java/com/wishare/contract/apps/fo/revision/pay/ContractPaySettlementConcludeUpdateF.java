...
public class ContractPaySettlementConcludeUpdateF {
    ...
    private List<ContractPaySettDetailsUpdateF> contractPaySettDetailsSaveFList;

    @ApiModelProperty("结算扣款明细")
    private List<ContractPayConcludeSettdeductionUpdateF> contractPayConcludeSettdeductionSaveFList;
