...
@ApiModel(value = "收入合同订立信息表新增参数AddF", description = "收入合同订立信息表新增参数AddF")
public class ContractIncomeAddF {

    @ApiModelProperty("中交合同主数据id")
    private String fromid;

    @ApiModelProperty("枫行梦临时id")
    private String bindpointresources;
    ...
    @ApiModelProperty("id (存在变更或续签操作时视作relationId)")
    private String id;
    /**
     * 合同编号
     */
     ...
     * 操作类型 1 变更   2 续签
     */
    @ApiModelProperty("操作类型 1 变更   2 续签")
     ...
     * fkdwxx
     */
    @ApiModelProperty("(合同投标测算数据)")
    private List<ContractCttmsjF> cttmsj;
    /**
     * skdwxx
     */
