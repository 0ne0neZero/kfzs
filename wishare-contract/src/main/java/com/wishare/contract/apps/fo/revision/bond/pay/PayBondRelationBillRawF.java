...
/**
* <p>
* 缴纳保证金改版关联单据明细表 原生请求参数，该类会在每次重新自动生成时，重新生成！！！
* </p>
*
* @author chenglong
* @since 2023-07-28
...
@ApiModel(value = "缴纳保证金改版关联单据明细表原始请求参数", description = "缴纳保证金改版关联单据明细表原始请求参数，会跟着表重新生成")
public class PayBondRelationBillRawF {
