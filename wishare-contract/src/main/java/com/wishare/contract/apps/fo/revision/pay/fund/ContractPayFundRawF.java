...
/**
* <p>
* 支出合同-款项表 原生请求参数，该类会在每次重新自动生成时，重新生成！！！
* </p>
*
* @author chenglong
* @since 2023-06-25
...
@ApiModel(value = "支出合同-款项表原始请求参数", description = "支出合同-款项表原始请求参数，会跟着表重新生成")
public class ContractPayFundRawF {
    ...
    */
    ...
    @ApiModelProperty("需要查询返回的字段，不传时返回以下全部，可选字段列表如下"
        + "[\"id\",\"name\",\"typeId\",\"type\",\"amount\",\"chargeItemId\",\"chargeItem\",\"taxRateId\",\"taxRate\",\"payTypeId\",\"payType\",\"payWayId\",\"payWay\",\"startDate\",\"endDate\",\"standardId\",\"standard\",\"remark\",\"tenantId\",\"creator\",\"creatorName\",\"gmtCreate\",\"operator\",\"operatorName\",\"gmtModify\",\"deleted\"]"
        + "id 主键ID"
        + "name 款项名称"
        + "typeId 款项类型ID"
        + "type 款项类型"
