...
/**
* <p>
* 支出合同订立信息拓展表 原生请求参数，该类会在每次重新自动生成时，重新生成！！！
* </p>
*
* @author chenglong
* @since 2023-09-24
...
@ApiModel(value = "支出合同订立信息拓展表原始请求参数", description = "支出合同订立信息拓展表原始请求参数，会跟着表重新生成")
public class ContractPayConcludeExpandRawF {
