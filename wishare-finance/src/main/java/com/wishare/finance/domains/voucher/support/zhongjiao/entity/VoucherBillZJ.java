...
@Getter
@Setter
@TableName(value = TableNames.VOUCHER_BILL_ZJ, autoResultMap = true)
public class VoucherBillZJ extends BaseEntity {
    ...
    @ApiModelProperty(value = "单据类型 1 收入确认 2资金收款 3 对下结算  4 支付申请")
