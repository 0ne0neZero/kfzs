...
@Getter
@Setter
@TableName(value = TableNames.VOUCHER_BILL_DETAIL_DX_ZJ, autoResultMap = true)
public class VoucherPushBillDetailDxZJ extends BaseEntity {
