...
@Component
public class BpmTaxAmountLogicStrategy implements BpmLogicStrategy {
    @Override
    public VoucherTemplateBpmLogicCodeEnum logicCode() {
        return VoucherTemplateBpmLogicCodeEnum.原币税额;
    }
    ...
    public BigDecimal logicValue(ProcessAccountBookF accountBook, int index,String bpmBillTypeCode) {
        ...
        return AmountUtils.longToDecimal(chargeDetailF.getTaxAmount());
    }
}
