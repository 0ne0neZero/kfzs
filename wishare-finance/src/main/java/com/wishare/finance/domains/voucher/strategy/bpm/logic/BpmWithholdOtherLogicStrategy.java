...
// @Component
// @Slf4j
// public class BpmWithholdOtherLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.扣缴其它;
//     }
//
//     @Override
...
//             string = wageTableF.getWithholdOther();
...
//             string = infoF.getWithholdOther();
//         } else {
//             string = "0";
//             log.error("BpmLogicStrategy取值异常,入参:{},index-{},bpmBillTypeCode-{},logicCode-{}", JSONObject.toJSONString(accountBook), index, bpmBillTypeCode, VoucherTemplateBpmLogicCodeEnum.扣缴其它.getValue());
//         }
