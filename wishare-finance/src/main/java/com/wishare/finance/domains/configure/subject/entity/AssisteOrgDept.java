...
@Getter
@Setter
@TableName(value = TableNames.ASSISTE_ORG_DEPT)
@ApiModel(value="AssisteOrgDept对象", description="辅助核算（部门）")
public class AssisteOrgDept implements Serializable {
    ...
    public void updateOrInsert(){
        if(id == null){
            id = IdentifierFactory.getInstance().generateLongIdentifier(TableNames.ASSISTE_ORG_DEPT);
        }
        if (creator == null){
