...
import com.wishare.finance.domains.reconciliation.enums.ReconciliationYinlianStateEnum;
...
@Getter
@Setter
@ApiModel("标准消费对账文件(银联txt文件内容)")
@TableName("reconciliation_yinlian")
public class ReconciliationYinlianE {
    ...
    /**
     * {@linkplain ReconciliationYinlianStateEnum}
     */
