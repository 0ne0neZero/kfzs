 ...
 */
@Component
public class CostCenterSummaryStrategy implements SummaryStrategy {

    @Override
    public VoucherTemplateSummaryTypeEnum summaryType() {
        return VoucherTemplateSummaryTypeEnum.成本中心;
    }

    @Override
    public String summary(VoucherTemplateEntrySummary entrySummary, VoucherBusinessBill businessBill) {
        return Objects.isNull(businessBill.getCostCenterName()) ? "" : businessBill.getCostCenterName();
    }
}
