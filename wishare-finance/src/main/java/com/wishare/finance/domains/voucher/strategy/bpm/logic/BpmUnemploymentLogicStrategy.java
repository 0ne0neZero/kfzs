...
// @Component
// @Slf4j
// public class BpmUnemploymentLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.扣缴失业;
//     }
//
//     @Override
...
//             string = wageTableF.getUnemployment();
...
//             string = infoF.getUnemployment();
//         } else {
//             string = "0";
//             log.error("BpmLogicStrategy取值异常,入参:{},index-{},bpmBillTypeCode-{},logicCode-{}", JSONObject.toJSONString(accountBook), index, bpmBillTypeCode, VoucherTemplateBpmLogicCodeEnum.扣缴失业.getValue());
//         }
