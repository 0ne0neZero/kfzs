...
//
// @Component
// public class BpmExcitationTotalLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.激励合计;
//     }
//
//     @Override
...
//         return StrUtil.isBlank(chargeDetailF.getExcitationTotal()) ? BigDecimal.ZERO :
//                 new BigDecimal(chargeDetailF.getExcitationTotal());
//     }
// }
