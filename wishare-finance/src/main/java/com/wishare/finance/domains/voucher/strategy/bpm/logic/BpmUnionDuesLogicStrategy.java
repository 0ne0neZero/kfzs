...
// @Component
// @Slf4j
// public class BpmUnionDuesLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.代扣工会会费;
//     }
//
//     @Override
...
//             string = wageTableF.getUnionDues();
...
//             string = infoF.getUnionDues();
//         } else {
//             string = "0";
//             log.error("BpmLogicStrategy取值异常,入参:{},index-{},bpmBillTypeCode-{},logicCode-{}", JSONObject.toJSONString(accountBook), index, bpmBillTypeCode, VoucherTemplateBpmLogicCodeEnum.代扣工会会费.getValue());
//         }
