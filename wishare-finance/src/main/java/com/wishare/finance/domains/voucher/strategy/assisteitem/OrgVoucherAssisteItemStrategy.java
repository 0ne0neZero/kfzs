...
public class OrgVoucherAssisteItemStrategy implements VoucherAssisteItemStrategy {
    ...
    public AssisteItemOBV getByBus(VoucherBusinessBill businessBill) {
        return voucherFacade.getAssisteItem(String.valueOf(businessBill.getStatutoryBodyId()), type());
    }
