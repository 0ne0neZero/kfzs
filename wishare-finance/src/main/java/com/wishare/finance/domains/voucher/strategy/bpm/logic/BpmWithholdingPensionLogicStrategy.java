...
// @Component
// @Slf4j
// public class BpmWithholdingPensionLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.扣缴养老;
//     }
//
//     @Override
...
//             string = wageTableF.getWithholdingPension();
...
//             string = infoF.getWithholdingPension();
//         } else {
//             string = "0";
//             log.error("BpmLogicStrategy取值异常,入参:{},index-{},bpmBillTypeCode-{},logicCode-{}", JSONObject.toJSONString(accountBook), index, bpmBillTypeCode, VoucherTemplateBpmLogicCodeEnum.扣缴养老.getValue());
//         }
