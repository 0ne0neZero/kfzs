...
@Component
public class BpmExcTaxAmountLogicStrategy implements BpmLogicStrategy {
    @Override
    public VoucherTemplateBpmLogicCodeEnum logicCode() {
        return VoucherTemplateBpmLogicCodeEnum.原币金额_不含税;
    }
    ...
    public BigDecimal logicValue(ProcessAccountBookF accountBook, int index,String bpmBillTypeCode) {
        ...
        return AmountUtils.longToDecimal(chargeDetailF.getExcTaxAmount());
    }
}
