...
// @Component
// @Slf4j
// public class BpmPersonalIncomeTaxLogicStrategy implements BpmLogicStrategy {
//
//     @Override
//     public VoucherTemplateBpmLogicCodeEnum logicCode() {
//         return VoucherTemplateBpmLogicCodeEnum.代扣个税;
//     }
//
//     @Override
...
//             string = wageTableF.getPersonalIncomeTax();
...
//             string = infoF.getPersonalIncomeTax();
//         } else {
//             string = "0";
//             log.error("BpmLogicStrategy取值异常,入参:{},index-{},bpmBillTypeCode-{},logicCode-{}", JSONObject.toJSONString(accountBook), index, bpmBillTypeCode, VoucherTemplateBpmLogicCodeEnum.代扣个税.getValue());
//         }
