...
@Getter
@Setter
@TableName(value = TableNames.ASSISTE_INOUTCLASS)
@ApiModel(value="AssisteInoutclass对象", description="辅助核算（收支项目）")
public class AssisteInoutclass implements Serializable {
    ...
    public void updateOrInsert(){
        if(id == null){
            id = IdentifierFactory.getInstance().generateLongIdentifier(TableNames.ASSISTE_INOUTCLASS);
        }
        if (creator == null){
