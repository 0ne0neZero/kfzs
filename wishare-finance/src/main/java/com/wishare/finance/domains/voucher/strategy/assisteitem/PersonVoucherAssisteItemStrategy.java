...
public class PersonVoucherAssisteItemStrategy implements VoucherAssisteItemStrategy {
    ...
    public AssisteItemOBV getByBus(VoucherBusinessBill businessBill) {
        return voucherFacade.getAssisteItem(businessBill.getCustomerId(), type());
    }
