 ...
 */
@Service
public class PayIncomeConfirmBilDxlZJStrategy extends ManualZJBillStrategy<ManualBillZJStrategyCommand> {

    public PayIncomeConfirmBilDxlZJStrategy() {
        super(ZJTriggerEventBillTypeEnum.收入确认计提);
    }
    ...
    public List<PushZJBusinessBillForSettlement> businessZJBillsForPayIncome(List<VoucherBillRuleConditionOBV> conditions, List<String> communityIds) {
        return pushBillZJFacade.getReceivableBillZJListForPayIncome(conditions,communityIds,null,5);
    }
