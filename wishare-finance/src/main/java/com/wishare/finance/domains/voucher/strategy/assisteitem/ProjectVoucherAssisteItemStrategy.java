...
public class ProjectVoucherAssisteItemStrategy implements VoucherAssisteItemStrategy {
    ...
    public AssisteItemOBV getByBus(VoucherBusinessBill businessBill) {
        return voucherFacade.getAssisteItem(String.valueOf(businessBill.getCostCenterId()), type());
    }
