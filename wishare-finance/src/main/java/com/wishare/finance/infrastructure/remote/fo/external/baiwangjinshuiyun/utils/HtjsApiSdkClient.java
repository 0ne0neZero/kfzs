...
public final class HtjsApiSdkClient {
    ...
    public static final String X_HTJS_UA = "x-htjs-ua";
    public static final String X_HTJS_NONCE = "x-htjs-nonce";
    private static String[] enforeHeadersArr = {"host", "date", X_HTJS_UA, X_HTJS_NONCE};
    ...
    public Map<String, String> get_signed_headers(String method, String url, Map<String, String> headers, String httpVersion) throws HtjsApiSdkError, HtjsApiSdkError {
        ...
        if (!sign_headers.containsKey(X_HTJS_UA)) {
            ...
            headers.put(X_HTJS_UA, ua);
            sign_headers.put(X_HTJS_UA, ua);
        }

        if (!sign_headers.containsKey(X_HTJS_NONCE)) {
            String nonce = UUID.randomUUID().toString();
            headers.put(X_HTJS_NONCE, nonce);
            sign_headers.put(X_HTJS_NONCE, nonce);
        }
