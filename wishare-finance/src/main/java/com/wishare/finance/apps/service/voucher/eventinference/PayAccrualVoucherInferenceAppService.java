 ...
 */
@Service
public class PayAccrualVoucherInferenceAppService extends AbstractVoucherInferenceAppService {

    @Override
    public EventTypeEnum getEventType() {
//        return EventTypeEnum.支出_应付计提;
    ...
    public void inferenceByBillType(Integer eventType, List<Field> fieldList,
        ...
        super.getPayBankAccount(conditions, fieldList, "b", "sb_account_id");
