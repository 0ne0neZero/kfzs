...
public class AddAccountBookF {
    ...
    @ApiModelProperty(value = "法定单位id路径",required = true)
    @NotNull(message = "法定单位id路径不能为空")
    ...
    public AddAccountBookCommand getAddAccountBookCommand() {
        AddAccountBookCommand accountBookCommand = Global.mapperFacade.map(this, AddAccountBookCommand.class);
        ...
        accountBookCommand.setAccountBookGroupDtoList(groupDtoList);
        return accountBookCommand;
    }
}
