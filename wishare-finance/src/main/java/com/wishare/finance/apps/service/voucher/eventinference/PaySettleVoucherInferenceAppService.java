 ...
 */
@Service
public class PaySettleVoucherInferenceAppService extends AbstractVoucherInferenceAppService {

    @Override
    public EventTypeEnum getEventType() {
//        return EventTypeEnum.支出_付款结算;
    ...
    public void inferenceByBillType(Integer eventType, List<Field> fieldList,
        ...
        super.inferenceDetailByBillType(eventType, fieldList, conditions, record, isSingle, BillTypeEnum.付款单);
    }
