 ...
 */
@Service
public class DefaultVoucherInferenceAppService extends AbstractVoucherInferenceAppService {
    ...
    public void inferenceByBillType(Integer eventType, List<Field> fieldList,
        ...
        super.inferenceByBillType(eventType, fieldList, conditions, record, isSingle);
    }
    ...
    public Map<String, Object> inferPrefabricationVoucher(List<VoucherE> voucherList) {
        return super.inferPrefabricationVoucher(voucherList);
    }
}
